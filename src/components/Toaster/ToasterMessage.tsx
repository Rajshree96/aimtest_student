...
export const loginSuccess = 'You Are Logged In Successfully';
...
export const packageStatusUpdate = 'Status Updated Successfully';
export const userStatusUpdate = 'Status Updated Successfully';
